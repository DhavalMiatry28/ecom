...
E-commerce</a>
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul class="navbar-nav mr-auto text-uppercase">
			...
			<li>
				<a class="active" href="view_my_account.php">My Account</a>
			</li>
			<li>
		...
		<?php else: ?>
			<a href="../view_cart.php" class="btn btn-success mr-2"><i class="fas fa-shopping-cart"></i><span> 0 items in Cart</span></a>
		<?php endif ?>
