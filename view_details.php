...
<nav class="navbar navbar-expand-lg navbar-light bg-light sticky-top" id="navbar">
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul class="navbar-nav mr-auto text-uppercase">
			...
			<li>
				<a class="active" href="view_shop.php">Shop</a>
			</li>
	  ...
	  <div class="row">
	  	...
	  	<div class="col-sm-6 col-md-3 justify-content-center single">
				<div class="product mb-4">
					<div class="card">
					  <a href="view_details.php?product_id=<?php echo $product_id; ?>"><img class="card-img-top img-fluid p-3" src="admin_area/product_images/<?php echo $product_img1; ?>" alt="Card image cap"></a>
